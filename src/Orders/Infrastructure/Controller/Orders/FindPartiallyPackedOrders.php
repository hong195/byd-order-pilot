...
#[AsController]
#[Route('/api/orders/partially-packed', name: 'find_partially_packed', methods: ['GET'])]
final readonly class FindPartiallyPackedOrders
{
    ...
    {
        $orders = $this->privateQueryInteractor->findPartiallyPacked();
