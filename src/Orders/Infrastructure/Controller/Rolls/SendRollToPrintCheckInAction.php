 ...
 */
#[AsController]
#[Route('/api/rolls/print/{rollId}', name: 'send_roll_to_print_check_in', requirements: ['rollId' => '^\d+$'], methods: ['POST'])]
final class SendRollToPrintCheckInAction extends BaseController
{
    ...
    {
        $this->privateCommandInteractor->sendToPrintCheckIn($rollId);
