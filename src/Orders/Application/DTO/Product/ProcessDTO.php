...
final readonly class ProcessDTO
{
     ...
     */
    public function __construct(public int $productId, public string $process, public ?int $rollId = null, public bool $isReprint = false, public bool $isReadyForPacking = false, public ?string $photo = null)
    {
    }
}
