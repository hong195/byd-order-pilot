...
class RollFactory
{
     ...
     * @param int         $priority     the priority of the roll (optional)
     ...
     */
    public function create(string $name, string $quality, string $rollType, int $priority = 0, int $length = 0, ?string $qualityNotes = null): Roll
    {
        return new Roll(
            name: $name,
