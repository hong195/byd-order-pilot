 ...
 */
final class Version20241216183200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prod_process_printed_product (id VARCHAR(26) NOT NULL, photo_id VARCHAR(26) DEFAULT NULL, roll_id VARCHAR(26) DEFAULT NULL, related_product_id VARCHAR(255) DEFAULT NULL, length NUMERIC(15, 2) DEFAULT NULL, order_number VARCHAR(255) DEFAULT NULL, lamination_type VARCHAR(255) DEFAULT NULL, film_type VARCHAR(255) DEFAULT NULL, has_priority BOOLEAN DEFAULT NULL, sort_order INT DEFAULT 0, is_reprint BOOLEAN DEFAULT false NOT NULL, date_added TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE prod_process_roll (id VARCHAR(26) NOT NULL, parent_roll_id VARCHAR(26) DEFAULT NULL, printer_id VARCHAR(26) DEFAULT NULL, name VARCHAR(255) NOT NULL, employee_id INT DEFAULT NULL, film_id VARCHAR(255) DEFAULT NULL, process VARCHAR(255) DEFAULT NULL, is_locked BOOLEAN DEFAULT false NOT NULL, date_added TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE prod_process_roll_history (id VARCHAR(26) NOT NULL, roll_id VARCHAR(255) DEFAULT NULL, parent_roll_id VARCHAR(255) DEFAULT NULL, employee_id VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, process VARCHAR(255) NOT NULL, happened_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE shared_media_files (id VARCHAR(26) NOT NULL, filename VARCHAR(255) NOT NULL, source VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, type VARCHAR(50) DEFAULT NULL, owner_id VARCHAR(255) DEFAULT NULL, owner_type VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE orders_product ADD CONSTRAINT FK_223F76D69D3FDAA8 FOREIGN KEY (cut_file_id) REFERENCES shared_media_files (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE orders_product ADD CONSTRAINT FK_223F76D6B6A86CB2 FOREIGN KEY (print_file_id) REFERENCES shared_media_files (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE prod_process_printed_product ADD CONSTRAINT FK_453DEB627E9E4C8C FOREIGN KEY (photo_id) REFERENCES shared_media_files (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE shared_media_files');
