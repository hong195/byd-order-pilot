...
final readonly class PrintedProductDataTransformer
{
     ...
     */
    public function fromEntity(PrintedProduct $product, ?string $cutFileUrl = null, ?string $printFileUrl = null, ?string $photoUrl = null, bool $isPacked = false): PrintedProductData
    {
